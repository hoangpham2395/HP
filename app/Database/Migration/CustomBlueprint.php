...
class CustomBlueprint extends Blueprint
{
    ...
    public function timestamps($precision = 0)
    {
        ...
        $this->timestamp(getUpdatedAtColumn(), $precision)->nullable()->comment(getUpdatedAtColumn('comment'))->default(getConstant('DEFAULT_TIMESTAMP'));
    }
    ...
    public function softDeletes($column = '', $precision = 0)
    {
        ...
        return getDelFlagColumn() ? $this->char(getDelFlagColumn(), '1')->default(getDelFlagColumn('active'))->comment(getDelFlagColumn('comment')) : null;
    }
