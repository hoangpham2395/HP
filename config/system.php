...
return [
    ...
    'default_auth_id' => 1,
    'created_at_column' => ['field' => 'created_at'],
    'updated_at_column' => ['field' => 'updated_at'],
    'deleted_at_column' => [],
    'del_flag_column' => ['field' => 'del_flag', 'active' => 1, 'deleted' => 0],
    ...
    'form_open_class_default' => ' form-horizontalx ',
    // webpack config
    'use_webpack' => env('USE_WEBPACK', false),
];
